...
const copyToClip = () => { navigator.clipboard.writeText(gameCode.value) }
</script>
...
<template>
  <div class="space-y-3 text-center">
    <p v-if="!isReady" class="font-medium text-slate-300">
      ...
      <i @click="copyToClip" class="fa-solid fa-copy text-blue-300 ml-1 hover:text-blue-800 cursor-pointer"></i>
    </p>
