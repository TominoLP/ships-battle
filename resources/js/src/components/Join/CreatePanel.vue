...
<template>
  <div class="space-y-3">
    ...
    <div v-if="showMode === 'none'" class="flex gap-2">
      <button
          @click="handleCreate"
          class="w-1/2 bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded-lg"
      >Spiel erstellen</button>

      <button
          @click="handleJoin"
          class="w-1/2 bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg"
      >Spiel beitreten</button>
    </div>

    <!-- Create mode: show only name input -->
    ...
    <!-- Join mode: show name and game code inputs -->
