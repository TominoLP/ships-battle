...
const statusMessage = computed(() => {
  switch (gs.step) {
    case 'join':
      return 'Gib deinen Namen ein und erstelle oder trete einem Spiel bei.';
    case 'lobby':
      return 'Warte in der Lobby, bis beide bereit sind.';
    case 'placing':
      return 'Platziere deine Schiffe auf dem Spielfeld.';
    case 'playing':
      return gs.gameOver ? 'Spiel beendet.' : (gs.myTurn ? 'Dein Zug!' : 'Gegner am Zug …');
    default:
      return '';
  }
});
